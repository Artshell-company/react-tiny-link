(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['[libraryCamelCaseName]'] = {}, global.React, global.styled));
    ...
    ***************************************************************************** */
    ...
    // Media Style
    var smallMediaStyle = styled.css(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  height: 127px;\n"], ["\n  height: 127px;\n"])));
    var largeMediaStyle = styled.css(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  height: ", ";\n"], ["\n  height: ", ";\n"
        // Content Style
    ])), function (_a) {
    ...
    // Content Style
    var largeContentStyle = styled.css(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  flex: 0 0 125px;\n"], ["\n  flex: 0 0 125px;\n"])));
    var smallDescriptionStyle = styled.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  p {\n    -webkit-box-orient: vertical;\n    display: -webkit-box;\n    -webkit-line-clamp: ", ";\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: normal;\n  }\n  ", ";\n"], ["\n  p {\n    -webkit-box-orient: vertical;\n    display: -webkit-box;\n    -webkit-line-clamp: ", ";\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: normal;\n  }\n  ",
        ";\n"])), function (_a) {
    ...
    var largeDescriptionStyle = styled.css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  p {\n    -webkit-box-orient: vertical;\n    display: -webkit-box;\n    -webkit-line-clamp: ", ";\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: normal;\n  }\n  ", ";\n"], ["\n  p {\n    -webkit-box-orient: vertical;\n    display: -webkit-box;\n    -webkit-line-clamp: ", ";\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: normal;\n  }\n  ",
        ";\n"
    ...
    // Styled Components for cards
    var Media = styled__default['default']('div')(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    display: block;\n    height: auto;\n    position: relative;\n    background: ", ";\n    \n    flex: ", "\n    overflow: hidden;\n    transition: flex-basis 0.25s ease-in-out 0s;\n"], ["\n    display: block;\n    height: auto;\n    position: relative;\n    background: ",
        ";\n    \n    flex: ", "\n    overflow: hidden;\n    transition: flex-basis 0.25s ease-in-out 0s;\n"])), function (_a) {
    ...
    var Video = styled__default['default']('video')(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\nwidth:100%;\ndisplay: block;\nheight: 100%;\n    position: relative;\n    flex: ", "\n    overflow: hidden;\nobject-fit:cover\n"], ["\nwidth:100%;\ndisplay: block;\nheight: 100%;\n    position: relative;\n    flex: ", "\n    overflow: hidden;\nobject-fit:cover\n"])), function (_a) {
        var cardSize = _a.cardSize;
        return (isLarge(cardSize) ? '1 1 0%;' : '0 0 125px;');
    });
    var ContentWrapper = styled__default['default']('div')(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-around;\n  flex-direction: column;\n  flex: 1;\n  padding: 10px 15px;\n  min-width: 0;\n  box-sizing: border-box;\n  ", ";\n"], ["\n  display: flex;\n  justify-content: space-around;\n  flex-direction: column;\n  flex: 1;\n  padding: 10px 15px;\n  min-width: 0;\n  box-sizing: border-box;\n  ", ";\n"])), function (_a) {
        var cardSize = _a.cardSize;
        return isLarge(cardSize) && largeContentStyle;
    });
    var Header = styled__default['default']('header')(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  text-align: left;\n  font-size: 16px;\n  font-weight: bold;\n  margin: 0;\n  flex-grow: 1.2;\n\n  ", ";\n"], ["\n  text-align: left;\n  font-size: 16px;\n  font-weight: bold;\n  margin: 0;\n  flex-grow: 1.2;\n\n  ", ";\n"])), function (_a) {
        var cardSize = _a.cardSize;
        return (!isLarge(cardSize) ? smallDescriptionStyle : largeDescriptionStyle);
    });
    var Content = styled__default['default']('div')(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  text-align: left;\n  font-size: 14px;\n  flex-grow: 1;\n  margin: auto 0;\n  line-height: 18px;\n\n  ", ";\n"], ["\n  text-align: left;\n  font-size: 14px;\n  flex-grow: 1;\n  margin: auto 0;\n  line-height: 18px;\n\n  ", ";\n"])), function (_a) {
        var cardSize = _a.cardSize;
        return (!isLarge(cardSize) ? smallDescriptionStyle : largeDescriptionStyle);
    });
    var Footer = styled__default['default']('footer')(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  text-align: left;\n  font-size: 12px;\n  margin: 0;\n  flex-grow: 0;\n"], ["\n  text-align: left;\n  font-size: 12px;\n  margin: 0;\n  flex-grow: 0;\n"])));
    var Card = styled__default['default']('a')(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  max-width: ", ";\n  background-color: rgb(255, 255, 255);\n  color: rgb(24, 25, 25);\n  font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;\n  display: flex;\n  opacity: 1;\n  position: relative;\n  transition-duration: 0.35s;\n  transition-timing-function: ease-in-out;\n  flex-direction: ", "\n    ", ";\n\n  transition-property: background, border-color, height;\n  border-width: 1px;\n  border-style: solid;\n  border-color: rgb(225, 232, 237);\n  overflow: hidden;\n  text-decoration: none;\n  -webkit-tap-highlight-color: rgb(245, 248, 250);\n  cursor: pointer;\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.08);\n  &:hover {\n    background: rgb(245, 248, 250);\n  }\n"], ["\n  max-width: ", ";\n  background-color: rgb(255, 255, 255);\n  color: rgb(24, 25, 25);\n  font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;\n  display: flex;\n  opacity: 1;\n  position: relative;\n  transition-duration: 0.35s;\n  transition-timing-function: ease-in-out;\n  flex-direction: ", "\n    ", ";\n\n  transition-property: background, border-color, height;\n  border-width: 1px;\n  border-style: solid;\n  border-color: rgb(225, 232, 237);\n  overflow: hidden;\n  text-decoration: none;\n  -webkit-tap-highlight-color: rgb(245, 248, 250);\n  cursor: pointer;\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.08);\n  &:hover {\n    background: rgb(245, 248, 250);\n  }\n"])), function (_a) {
        var width = _a.width;
    ...
    // Key Frames
    var shimmerKeyFrame = styled.keyframes(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n   0%{\n        background-position: 100% 80%;\n    }\n    100%{\n        background-position: 0 80%;\n    }\n"], ["\n   0%{\n        background-position: 100% 80%;\n    }\n    100%{\n        background-position: 0 80%;\n    }\n"])));
    var loadingStyle = styled.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  animation-duration: 1.4s;\n  animation-fill-mode: forwards;\n  animation-iteration-count: infinite;\n  animation-timing-function: linear;\n  animation-name: ", ";\n  background: darkgray;\n  background: linear-gradient(90deg, #cacaca 25%, #e4e4e4 37%, #f7f6f6 63%);\n  background-size: 800px 100%;\n  color: transparent;\n  -webkit-line-clamp: 1;\n  border-radius: 10px;\n  width: ", ";\n"], ["\n  animation-duration: 1.4s;\n  animation-fill-mode: forwards;\n  animation-iteration-count: infinite;\n  animation-timing-function: linear;\n  animation-name: ", ";\n  background: darkgray;\n  background: linear-gradient(90deg, #cacaca 25%, #e4e4e4 37%, #f7f6f6 63%);\n  background-size: 800px 100%;\n  color: transparent;\n  -webkit-line-clamp: 1;\n  border-radius: 10px;\n  width: ", ";\n"])), shimmerKeyFrame, function (_a) {
    ...
    var UnstyledDescription = function (_a) {
        ...
        return (React__namespace.createElement("p", __assign({}, props, { className: className }), props.children));
    };
    var Description = styled__default['default'](UnstyledDescription)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  &&& {\n    text-align: inherit;\n    font-weight: inherit;\n    font-family: inherit;\n    color: inherit;\n    margin: 0;\n    ", "\n  }\n"], ["\n  &&& {\n    text-align: inherit;\n    font-weight: inherit;\n    font-family: inherit;\n    color: inherit;\n    margin: 0;\n    ", "\n  }\n"])), function (_a) {
    ...
    var ImageWrapper = function (_a) {
        ...
        return React__namespace.createElement("img", { style: { display: "none" }, src: imageUrl, onError: function (e) {
    ...
    var VideoWrapper = function (_a) {
        ...
        return React__namespace.createElement(Video, { muted: true, onCanPlayThrough: function (e) {
                var video = e.target;
                setTimeout(function () {
                    video.pause();
                }, 1000);
            }, autoPlay: autoPlay, controls: true },
            React__namespace.createElement("source", { src: videoUrl + "#t=0.1" }));
    };
    var CardMedia = function (_a) {
        ...
        return (React__namespace.createElement(React__namespace.Fragment, null,
            data.type !== ReactTinyLinkType.TYPE_VIDEO && (React__namespace.createElement(Media, { className: "react_tinylink_card_media", cardSize: cardSize, src: data.image && (secureImageUrl ? secureImageUrl : data.image[0]), type: data.type, style: { WebkitFilter: 'blur(10px)', filter: 'blur(10px)' } },
                React__namespace.createElement(ImageWrapper, { data: data, secureImageUrl: secureImageUrl, loadSecureUrl: loadSecureUrl }))),
            data.type && data.type === ReactTinyLinkType.TYPE_VIDEO && (React__namespace.createElement(Media, { className: "react_tinylink_card_media", cardSize: cardSize, src: data.video && (secureVideoUrl ? secureVideoUrl : data.video[0]), type: data.type },
                React__namespace.createElement(VideoWrapper, { data: data, secureVideoUrl: secureVideoUrl, autoPlay: autoPlay, loadSecureUrl: loadSecureUrl })))));
    };
    ...
    var ReactTinyLink = function (_a) {
        ...
        return (React__namespace.createElement(Card, { onClick: function (e) {
                if (!onClick)
                    return;
                e.preventDefault();
                onClick(e, data);
            }, className: "react_tinylink_card", cardSize: cardSize, href: url, width: width, isShownGraphic: showGraphic },
            showGraphic && (React__namespace.createElement(CardMedia, { autoPlay: autoPlay, cardSize: cardSize, data: data, loadSecureUrl: loadSecureUrl })),
            React__namespace.createElement(ContentWrapper, { className: "react_tinylink_card_content_wrapper", cardSize: cardSize },
                React__namespace.createElement(Header, { maxLine: maxLine, minLine: minLine, className: "react_tinylink_card_content_header" },
                    React__namespace.createElement(Description, { loading: loading, loadingWidth: 2, maxLine: maxLine, minLine: minLine, className: "react_tinylink_card_content_header_description" }, header ? header : data.title ? data.title : url)),
                React__namespace.createElement(Content, { maxLine: maxLine, minLine: minLine, className: "react_tinylink_card_content", cardSize: cardSize },
                    React__namespace.createElement(Description, { loading: loading, loadingWidth: 1, className: "react_tinylink_card_content_description" }, description ? description : data.description ? data.description : url)),
                React__namespace.createElement(Footer, { className: "react_tinylink_footer" },
                    React__namespace.createElement(Description, { loading: loading, loadingWidth: 1, className: "react_tinylink_card_footer_description" }, getHostname(url))))));
    };

    exports.ReactTinyLink = ReactTinyLink;
    exports.ScrapperWraper = ScrapperWraper;
    exports.useScrapper = useScrapper;
